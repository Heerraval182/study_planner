              ...
              children: [
                ...
                if (provider.sessions.isNotEmpty) ...[
                  ...
                  ...provider.sessions.map((session) {
                    final subj = provider.subjects.firstWhere(
                      (s) => s.id == session.subjectId,
                    );
                    final topic = subj.topics.firstWhere(
                      ...
                      child: ListTile(
                        ...
                        subtitle: Row(
                          children: [
                            ...
                            Text(
                              '${DateFormat.jm().format(session.date)} (${session.durationHours} hrs)',
